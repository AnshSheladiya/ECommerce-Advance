...
const productSchema = new mongoose.Schema({
    ...
    reviews: { type: String },
    related_products: { type: [mongoose.Schema.Types.ObjectId] },
    cross_sell_products: { type: [mongoose.Schema.Types.ObjectId] },
    upsell_products: { type: [mongoose.Schema.Types.ObjectId] },
    ...
    gift_wrapping_options: { type: [mongoose.Schema.Types.ObjectId] },
    ...
    backorder_availability: { type: String },
